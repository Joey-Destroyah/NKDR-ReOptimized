# NKDR-ReOptimized
is an **unofficial** fork of Joseano's and BrettRyland's NKD Renewed and Extended mod.
Which itself is a fork of NKDR, made by the author of the *og* North Kerbin Dynamics mod, harpwner and cukko (who is known on GitHub as dogevspenguin)
Which itself is a fork of the OG North Kerbin Dynamics Mod made by harpwner.
The OG NKD mod was developed under the CC-BY-SA license, so here's a link to that site
